...
├── 本篇  AI 平台集成与选型 ← 你在这里
└── 第 12 篇  从 Claude Code 源码学习 Harness 工程
```
...
| 混合架构 | 全部 | 核心自研 + 平台辅助 |
| Agent Harness 开发 | 第 12 篇 | 从 Claude Code 源码学架构 |
...
**下一篇预告：** [AI应用实践(12)—从Claude Code源码学习Harness工程]

前面 11 篇我们从聊天应用一路学到 AI 平台，但一直在"使用"别人造好的工具。下一篇我们换个视角——**拆解 Claude Code 的源码**（1,900+ 文件，512,000+ 行 TypeScript），看看一个生产级 AI Agent 的"驾驭框架"（Harness）到底是怎么设计的：启动预取优化、Agent 循环的两层架构、45+ 工具的并发执行器、五层权限决策管线、Hook 事件系统……这些工程模式不仅适用于 AI Agent 开发，也值得任何复杂系统借鉴。
